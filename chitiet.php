					...
					<div class="row">
						<div class="col-lg-12">
							<div class="hero-nav-area">
								<h1 class="text-white">Chi Tiết</h1>
								<p class="text-white link-nav"><a href="index.php">Trang Chủ </a>
					...
					<div class="col-lg-4">
						<div class="single-service d-flex flex-row">
							...
							<div class="details">
								...
								<p>
									Xin chào bạn, chào mừng bạn đã đến với trang của Magezine.
								</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-service d-flex flex-row">
							...
							<div class="details">
								...
								<p>
									Magezine sẽ mang đến cho bạn những tin tức nhanh chóng, thú vị.
								</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="single-service d-flex flex-row">
							...
							<div class="details">
								...
								<p>
									Magezine sẽ khiến bạn sẽ quay lại với chúng tôi một lần nữa.
									<br>Cảm ơn bạn!
								</p>
							</div>
						</div>
